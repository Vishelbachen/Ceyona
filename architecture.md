...
3. **Fast path запрещён как лингвистический инструмент.**
   `_REVISE_SIGNALS` (английский keyword список) удалён. Языконезависимая
   семантическая классификация REVISE делегирована LLM judge полностью.
   Если fast path понадобится — он должен проверять структурные инварианты
   и служебные флаги, но не текст на конкретном языке. (audit.md SAFETY-3)
